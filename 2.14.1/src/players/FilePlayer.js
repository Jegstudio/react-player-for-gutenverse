...
const HLS_SDK_URL = getAssetPath() + '/reactplayer-hls.min.js'
const HLS_GLOBAL = 'Hls'
const DASH_SDK_URL = getAssetPath() + '/reactplayer-dash.all.min.js'
const DASH_GLOBAL = 'dashjs'
const FLV_SDK_URL = getAssetPath() + '/reactplayer-flv.min.js'
